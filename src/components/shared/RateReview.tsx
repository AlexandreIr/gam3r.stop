import {IconStar, IconStarFilled, IconStarHalfFilled, Icon3dCubeSphere } from '@tabler/icons-react';
...
export default function RateReview(props: RateReviewProps){
    ...
    return <div className="flex gap-0.5 text-emerald-400">{rateToStars(props.rate)}</div>
}